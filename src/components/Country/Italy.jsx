...
function Italy() {
  ...
  const italyData = {
    intro: {
      ...
      title: "Magical Italy",
      subtitle: "Where History Meets Art",
          ...
          travelGuide: {
            seasons: {
              winter: {
                ...
                temp: "0°C to 15°C",
                description: "Cold season, great for skiing in the Alps",
                highlights: ["Ski resorts", "Christmas markets", "Carnival of Venice"]
              },
              summer: {
                months: "June to August",
                temp: "20°C to 35°C",
                description: "Hot season, perfect for beach holidays",
                highlights: ["Amalfi Coast", "Sicilian beaches", "Outdoor festivals"]
              },
              spring: {
                months: "March to May",
                temp: "10°C to 25°C",
                description: "Mild weather, ideal for sightseeing",
                highlights: ["Tuscan countryside", "Easter celebrations", "Blooming gardens"]
              },
              autumn: {
                months: "September to November",
                temp: "10°C to 25°C",
                description: "Pleasant weather, great for wine tours",
                highlights: ["Harvest festivals", "Wine tasting", "Truffle hunting"]
              }
            },
            budget: {
              backpacker: {
                ...
                transport: "Public transport & Trains"
              },
              midRange: {
                daily: "€100-200",
                accommodation: "3-star hotels",
                food: "Mix of restaurants",
                transport: "Taxis & Regional trains"
              },
              luxury: {
                daily: "€300+",
              ...
              types: [
                {
                  ...
                  tips: ["Book in advance", "Check Trenitalia website", "Consider high-speed trains"]
                },
                {
                  mode: "Flight",
                  cost: "€50-200",
                ...
                },
                {
                  mode: "Bus",
                  cost: "€10-50",
                  description: "Good for shorter distances and rural areas",
                  tips: ["Use regional buses", "Book online for discounts", "Check schedules"]
                }
              ]
            },
            visa: {
            ...
            cuisine: {
              mustTry: [
                { dish: "Pizza Margherita", region: "Naples", type: "Veg" },
                { dish: "Pasta Carbonara", region: "Rome", type: "Non-Veg" },
                { dish: "Gelato", region: "Pan Italy", type: "Veg" },
                { dish: "Tiramisu", region: "Veneto", type: "Veg" }
              ],
              diningTips: [
                "Try local trattorias for authentic experience",
                "Street food is popular but choose hygienic vendors",
                "Many restaurants offer vegetarian options",
                "Wine is a staple with meals"
              ]
            },
            culture: {
              customs: [
              ...
              festivals: [
                { name: "Carnival of Venice", month: "February", type: "Cultural Festival" },
                { name: "Ferragosto", month: "August", type: "Public Holiday" },
                { name: "Christmas", month: "December", type: "Religious Festival" }
              ]
            },
            weather: {
              regions: [
                ...
                {
                  name: "Southern Italy",
                  climate: "Mild winters, very hot summers",
                  bestTime: "April to June, September to October"
                }
              ]
            },
            shopping: {
              ...
              markets: [
                { name: "Mercato Centrale", location: "Florence", specialty: "Food & Wine" },
                { name: "Porta Portese", location: "Rome", specialty: "Antiques & Flea Market" },
                { name: "La Rinascente", location: "Milan", specialty: "Luxury Shopping" }
              ],
              tips: [
                "Bargaining is not common in stores",
                "Quality varies widely - check thoroughly",
                "Get tax refund forms for large purchases",
                "Be careful with counterfeit items"
              ]
            }
          },
          highlights: [
            {
              image: "https://images.unsplash.com/photo-1552432552-06c0b0a94dda",  // Colosseum image
              title: "Historical Monuments",
              description: "Ancient ruins and architectural marvels"
            },
            {
              image: "https://images.unsplash.com/photo-1499426600726-a950358acf16",  // Uffizi Gallery in Florence
              title: "Art and Culture",
              description: "Renaissance art and vibrant culture"
            },
            {
              image: "https://images.unsplash.com/photo-1516483638261-f4dbaf036963",  // Cinque Terre coastline
              title: "Scenic Landscapes",
              description: "Beautiful coastlines and countryside"
            }
          ]
        }
      },
        ...
        places: [
          {
            name: "Colosseum",
            location: "Rome",
            image: "https://images.unsplash.com/photo-1552432552-06c0b0a94dda",  // Better Colosseum photo
            description: "An iconic symbol of Imperial Rome",
            tags: ["UNESCO Site", "Architecture", "History"]
          },
          {
            name: "Venice",
            location: "Veneto",
            image: "https://images.unsplash.com/photo-1523906921802-b5d2d899e93b",  // Venice canals photo
          ...
          },
          {
            name: "Florence",
            location: "Tuscany",
            image: "https://images.unsplash.com/photo-1541370976299-4d24ebbc9077",  // Florence Duomo photo
        ...
        activities: [
          {
            ...
            items: ["Cooking classes", "Wine tasting", "Food tours"]
          },
          {
            title: "Adventure",
            items: ["Hiking in the Dolomites", "Sailing in the Mediterranean", "Cycling in Tuscany"]
          },
          {
            title: "Cultural",
            items: ["Opera performances", "Art workshops", "Festival celebrations"]
          }
        ]
      }
    ]
        ...
        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
            <div>
              ...
              <div className="space-y-4">
                <p className="text-gray-700">{italyData.sections[0].content.travelGuide.visa.eVisa.process}</p>
                <div className="flex items-center text-gray-600">
                  <span className="font-medium mr-2">Duration:</span>
                  {italyData.sections[0].content.travelGuide.visa.eVisa.duration}
                </div>
                <div className="flex items-center text-gray-600">
                  <span className="font-medium mr-2">Cost:</span>
                  {italyData.sections[0].content.travelGuide.visa.eVisa.cost}
                </div>
              </div>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                {italyData.sections[0].content.travelGuide.visa.eVisa.requirements.map((req, idx) => (
                  <li key={idx} className="flex items-center text-gray-600">
                    <span className="text-orange-500 mr-2">✓</span>
                    {req}
                  </li>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <ul className="space-y-2">
                {italyData.sections[0].content.travelGuide.health.vaccinations.map((vax, idx) => (
                  <li key={idx} className="flex items-center text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <ul className="space-y-2">
                {italyData.sections[0].content.travelGuide.health.tips.map((tip, idx) => (
                  <li key={idx} className="flex items-center text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              {Object.entries(italyData.sections[0].content.travelGuide.health.emergencyContacts).map(([service, number]) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-4">
                {italyData.sections[0].content.travelGuide.cuisine.mustTry.map((dish, idx) => (
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <ul className="space-y-3">
                {italyData.sections[0].content.travelGuide.cuisine.diningTips.map((tip, idx) => (
                  <li key={idx} className="flex items-center text-gray-600">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <ul className="space-y-3">
                {italyData.sections[0].content.travelGuide.culture.customs.map((custom, idx) => (
                  <li key={idx} className="flex items-center text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              {italyData.sections[0].content.travelGuide.culture.festivals.map((festival, idx) => (
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <ul className="space-y-2">
                {italyData.sections[0].content.travelGuide.shopping.items.map((item, idx) => (
                  <li key={idx} className="flex items-center text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              {italyData.sections[0].content.travelGuide.shopping.markets.map((market, idx) => (
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg">
              ...
              <ul className="space-y-2">
                {italyData.sections[0].content.travelGuide.shopping.tips.map((tip, idx) => (
                  <li key={idx} className="flex items-center text-gray-600">
                    <span className="text-orange-500 mr-2">💡</span> {tip}
                  </li>
                ))}
